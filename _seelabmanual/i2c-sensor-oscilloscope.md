...
caption: Measure sensor readings at high speeds with precise timestamps for Fourier analysis
image:
  path: /assets/img/seelab/i2c_main.png
author: jithin
...
![](/assets/img/seelab/i2c_main.png){:class="ui image large lightbox floated" }

![](/assets/img/seelab/i2c_gauges.png){:class="ui image large lightbox floated" }
...
![](/assets/img/seelab/i2c_logger.png){:class="ui image huge lightbox" alt="I2C Logger"}
...
![](/assets/img/seelab/mpu_photo.jpeg){:class="ui image large lightbox floated" }

![](/assets/img/seelab/mpu_sinefit.png){:class="ui image large lightbox floated" }
...
![](/assets/img/seelab/mpu_raw.png){:class="ui image large lightbox floated" }

![](/assets/img/seelab/mpu_fft_zoom_fit.png){:class="ui image large lightbox floated" }
...
![](/assets/img/seelab/mpu_fft.png){:class="ui image fluid lightbox" }

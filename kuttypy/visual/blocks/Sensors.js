...
Blockly.Blocks['scanI2C'] = {
  ...
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('scanI2C');},'SS'));
    this.appendDummyInput()
...
Blockly.Blocks['scanI2CString'] = {
  ...
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('scanI2CString');},'SS'));
    this.appendDummyInput()
...
Blockly.Blocks['scanI2Cselector'] = {
  ...
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('scanI2Cselector');},'SS'));
    this.setColour(330);
    this.setOutput(true, null);
    this.setTooltip("Scan I2C");
    this.setHelpUrl("");
...
Blockly.Blocks['read_I2C_sensor'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_I2C_sensor');},'SS'));
    this.appendDummyInput()
        .appendField("Address:")
...
Blockly.Blocks['read_i2c_sensor_flexible'] = {
  init: function() {
    this.appendValueInput("NAME")
        .setCheck(null)
        .appendField("Read I2C Sensor")
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_i2c_sensor_flexible');},'SS'));
    this.appendDummyInput()
...
Blockly.Blocks['read_i2c_sensor_flexible_dynamic'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage(kuttypyMedia('i2cscan.png'), 100, 30,  "*", this.scan.bind(this),'SS'))
        .appendField(new Blockly.FieldDropdown(this.generateNameOptions.bind(this),this.validateName.bind(this)), "NAME")
        .appendField(new Blockly.FieldImage(kuttypyMedia('BMP280.png'), 60, 60),'IMAGE')
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_i2c_sensor_flexible_dynamic');},'SS'));
    this.appendDummyInput()
        .appendField("Parameter")
  ...
  validateName: function(newValue) {
    ...
    */
    ...
    image.setValue(kuttypyMedia(newValue.split(']')[1]+'.jpeg'));
...
Blockly.Blocks['read_i2c_sensor_flexible_dynamic_array'] = {
  ...
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldDropdown(this.generateNameOptions.bind(this),this.validateName.bind(this)), "NAME")
        .appendField(new Blockly.FieldImage(kuttypyMedia('BMP280.png'), 60, 60),'IMAGE')
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_i2c_sensor_flexible_dynamic_array');},'SS'));
    this.appendDummyInput()
...
Blockly.Blocks['read_BMP280'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('BMP280.png'), 30, 30, { alt: "*", flipRtl: "FALSE" }))
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_BMP280');},'SS'));
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['read_MS5611'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('BMP280.png'), 30, 30, { alt: "*", flipRtl: "FALSE" }))
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_MS5611');},'SS'));
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['read_TSL2561'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_TSL2561');},'SS'));
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['read_MAX30100'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('pulse.png'), 30, 30, { alt: "*", flipRtl: "FALSE" }))
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_MAX30100');},'SS'));
    this.appendDummyInput()
...
Blockly.Blocks['read_MAX6675'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('THERMOMETER.png'), 30, 30))
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_MAX6675');},'SS'));
    this.appendDummyInput()
...
Blockly.Blocks['read_MPU6050'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('MPU6050.png'), 20, 20, { alt: "*", flipRtl: "FALSE" }))
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_MPU6050');},'SS'));
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['read_VL53L0X'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_VL53L0X');},'SS'));
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['read_ML8511'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('read_ML8511');},'SS'));
    this.setOutput(true, null);
    this.setColour(230);
 this.setTooltip("");
 this.setHelpUrl("");
...
Blockly.Blocks['read_HMC5883L'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('MAGNETOMETER.png'), 20, 20, { alt: "*", flipRtl: "FALSE" }))

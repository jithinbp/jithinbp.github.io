...
Blockly.Blocks['mqtt_connect'] = {
  init: function() {
    this.appendDummyInput("TITLE")
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('remote.png'), 30, 30, { alt: "*", flipRtl: "FALSE" }));
...
Blockly.Blocks['mqtt_hasdata'] = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('mail.png'), 30, 30, { alt: "*", flipRtl: "FALSE" }));

...
Blockly.Blocks['move_stepper'] = {
 ...
 this.setHelpUrl("");
  ...
  this.imgbody = drawImage(this.getSvgRoot(),imgprops, kuttypyMedia('stepper_motor_body.png'));
  this.imgshaft = drawImage(this.getSvgRoot(),imgprops, kuttypyMedia('stepper_motor_shaft.png'));
...
Blockly.Blocks['move_steppers'] = {
  init: function() {
    this.appendDummyInput()
        ...
        .appendField(new Blockly.FieldImage(kuttypyMedia('help.svg'), 25, 25,  "*", ()=>{showBlockHelp('move_steppers');},'SS'));
 ...
 this.setHelpUrl("");
  ...
  this.imgbody1 = drawImage(this.getSvgRoot(),imgprops, kuttypyMedia('stepper_motor_body.png'));
  this.imgshaft1 = drawImage(this.getSvgRoot(),imgprops, kuttypyMedia('stepper_motor_shaft.png'));
  imgprops['y']=138;
  this.imgbody2 = drawImage(this.getSvgRoot(),imgprops, kuttypyMedia('stepper_motor_body.png'));
  this.imgshaft2 = drawImage(this.getSvgRoot(),imgprops, kuttypyMedia('stepper_motor_shaft.png'));

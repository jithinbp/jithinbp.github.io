...
caption: Create a surroundings mapping tool using the VL53L0X distance measurement sensor
image:
  path: /assets/blog/screenshots/Radar with VL53L0X and a Servo Motor.png
author: jithin
summary: |

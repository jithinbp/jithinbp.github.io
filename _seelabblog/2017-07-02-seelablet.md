...
layout: manual
title: SEELablet
caption: Instrumentation cluster for laboratories
image:
  path: /assets/img/seelab/dev/2.jpg
...
<span style="color:red;">Out of Stock</span> , Please refer to  <a href="/phd/seelab3/" target="_blank" class="ui inverted tiny green button">SEELab 3.0</a> . Purchase from <a href="https://csparkresearch.in/seelab3" target="_blank" class="ui inverted tiny green button">CSpark Research</a>
